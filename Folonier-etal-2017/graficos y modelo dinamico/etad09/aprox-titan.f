      ...
      open (1,file='nu-shell-12.dat')
      open (4,file='nu-core-12.dat')
...
c
       zcequ    = zc(1)*e**2/sty/rad/dos
       zcamp1   = dsqrt(zc(2)**2+zc(3)**2)*e/sty/rad/dos
       zcamp2   = dsqrt(zc(4)**2+zc(5)**2)*e**2/sty/rad/dos
       zcampatm = dsqrt(zc(6)**2+zc(7)**2)/sty/rad/dos
       zcsup    = zcequ+zcamp1
       zcinf    = zcequ-zcamp1
       zcsupatm = zcequ+zcamp1+zcamp2+zcampatm
       zcinfatm = zcequ-zcamp1-zcamp2-zcampatm
       write(4,106) zlg2,zcequ,zcsup,zcinf,zcsupatm,zcinfatm
c
...
c     parameters
      lams = cero
      lamc = cero
      eta  = 1.0d3*1.0d9   ! viscosity [Pa s]  !!!!!  [Pa s]= 1.0d3*[kg/km s]
