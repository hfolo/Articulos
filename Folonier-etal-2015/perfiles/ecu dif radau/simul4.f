      ...
      common /con/ iflag
      common /ene/ n,xis,etas,zc
      open (2,file='3ene.dat',status='replace')
      ...
      do i=0,in-1
       ...
       zhs = 2.0/(2.0+etas)
       zkf = 5.0*zhs/2.0-1.0
       write(2,204) n,zhs,zkf,zc
       write(*,204) n,zhs,zkf,zc
      end do
      close(2)
...
c     lazo principal de integracion y precision de la integracion.
       ...
       htime  = 4.0d-4        ! output interval (in days)
       h      = 4.0d-4        ! initial timestep (in days)
       ll     = 13
       y(1) = 0.0d0
       y(2) = 1.0d0
       y(3) = 0.0d0
...
c
      ...
      parameter (nmax=7,kmaxx=8,safe1=.25,safe2=.7,
